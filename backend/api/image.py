...
async def analyze_image(
    ...
    try:
        ...
        return {
            ...
            "ai_generated_probability": image_result.get("ai_probability"),
            "manipulation_probability": image_result.get("manipulation_probability"),
            "trust_score": scoring["trust_score"],
            "risk_level": scoring["risk_level"],
            "confidence": scoring["confidence"],
            "reasons": image_result.get("reasons", []),
            "visual_signals": image_result.get("visual_signals", []),
            "model_available": image_result.get("model_available", False),
            "gemini_available": image_result.get("gemini_available", False),
