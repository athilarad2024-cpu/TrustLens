...
async def analyze_video(
    ...
    try:
        ...
        return {
            ...
            "classification": video_result.get("classification"),
            "prediction": video_result.get("prediction"),
            "ai_probability": video_result.get("ai_probability"),
            "deepfake_probability": video_result.get("ai_probability"),
            "frames_analyzed": video_result.get("frames_analyzed", 0),
            "temporal_consistency_score": video_result.get("temporal_consistency_score", 0.7),
            "trust_score": scoring["trust_score"],
            "risk_level": scoring["risk_level"],
            "confidence": scoring["confidence"],
            "reasons": video_result.get("reasons", []),
            "visual_signals": video_result.get("visual_signals", []),
            "temporal_signals": video_result.get("temporal_signals", []),
            "model_available": video_result.get("model_available", False),
            "gemini_available": video_result.get("gemini_available", False),
